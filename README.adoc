...
image:https://github.com/redis-developer/mesclun/actions/workflows/gradle.yml/badge.svg["Build", link="https://github.com/redis-developer/mesclun/actions/workflows/gradle.yml"]
image:https://codecov.io/gh/redis-developer/mesclun/branch/master/graph/badge.svg?token=A5IX98M8JT["Coverage", link="https://codecov.io/gh/redis-developer/mesclun"]
