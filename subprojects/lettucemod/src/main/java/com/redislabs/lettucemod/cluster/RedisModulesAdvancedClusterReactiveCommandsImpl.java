...
import com.redislabs.lettucemod.RedisModulesReactiveCommandsImpl;
...
public class RedisModulesAdvancedClusterReactiveCommandsImpl<K, V> extends RedisAdvancedClusterReactiveCommandsImpl<K, V> implements RedisModulesAdvancedClusterReactiveCommands<K, V> {
    ...
    @Override
    public Mono<String> create(K key, com.redislabs.lettucemod.timeseries.CreateOptions options, Label<K, V>... labels) {
    ...
    @Override
    public Mono<Long> add(K key, long timestamp, double value, com.redislabs.lettucemod.timeseries.CreateOptions options, Label<K, V>... labels) {
