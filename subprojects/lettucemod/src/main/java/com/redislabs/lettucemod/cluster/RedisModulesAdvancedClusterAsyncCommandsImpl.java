...
import com.redislabs.lettucemod.RedisModulesAsyncCommandsImpl;
...
public class RedisModulesAdvancedClusterAsyncCommandsImpl<K, V> extends RedisAdvancedClusterAsyncCommandsImpl<K, V> implements RedisModulesAdvancedClusterAsyncCommands<K, V> {
    ...
    @Override
    public RedisFuture<String> create(K key, com.redislabs.lettucemod.timeseries.CreateOptions options, Label<K, V>... labels) {
    ...
    @Override
    public RedisFuture<Long> add(K key, long timestamp, double value, com.redislabs.lettucemod.timeseries.CreateOptions options, Label<K, V>... labels) {
