 ...
 *
 * The optional node affects scoring and ordering. If it evaluates to true, the
 * result is ranked higher. It is helpful to combine it with a {@link UnionNode}
 * to rank a document higher if it meets one of several criteria.
 *
