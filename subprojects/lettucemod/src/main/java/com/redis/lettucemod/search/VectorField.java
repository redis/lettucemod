...
public class VectorField<K> extends Field<K> {
	...
	private final SearchCommandKeyword type;
	...
	public boolean equals(Object o) {
		...
		return dim == that.dim && algorithm == that.algorithm && type == that.type && distanceMetric == that.distanceMetric && Objects.equals(initialCap, that.initialCap) && Objects.equals(blockSize, that.blockSize) && Objects.equals(m, that.m) && Objects.equals(efConstruction, that.efConstruction) && Objects.equals(efRuntime, that.efRuntime) && Objects.equals(epsilon, that.epsilon);
	}

	@Override
	public int hashCode() {
		return Objects.hash(super.hashCode(), algorithm, type, dim, distanceMetric, initialCap, blockSize, m, efConstruction, efRuntime, epsilon);
	}
	...
	public static class Builder<K> extends Field.Builder<K, Builder<K>> {
		...
		private SearchCommandKeyword type;
		private int dim;
		...
		public Builder<K> type(SearchCommandKeyword type) {
			this.type = type;
			return this;
		}
