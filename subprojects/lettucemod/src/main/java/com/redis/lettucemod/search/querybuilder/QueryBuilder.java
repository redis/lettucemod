 ...
 *
 * This class contains methods to construct query nodes. These query nodes can
 * be added to parent query nodes (building a chain) or used as the root query
 * node.
 *
 * You can use
 * 
...
public class QueryBuilder {
	 ...
	 * 
	 * @param field  The field that should contain this value. If this value is
	 *               empty, then any field will be checked.
	 * @param values Value to check for. The node will be true only if the field (or
	 *               any field) contains <i>all</i> of the values
	 * @return The node
	 */
	 ...
	 * 
	 * @param field       The field to check. If left null or empty, all fields will
	 *                    be checked.
	 ...
	 * @param values Values to search for. The node evaluates to true if
	 *               {@code field} matches any of the values
	 * @return The union node
	 */
	...
	/**
	 * Create a disjunct node. Disjunct nodes are true iff <b>any</b> of its
	 * children are <b>not</b> true. Conversely, this node evaluates to false if
	 * <b>all</b> its children are true.
	 * 
	...
	/**
	 * Create a disjunct node using one or more values. The node will evaluate to
	 * true iff the field does not match <b>any</b> of the values.
	 *
	...
	/**
	 * Create an optional node. Optional nodes do not affect which results are
	 * returned but they influence ordering and scoring.
	 * 
