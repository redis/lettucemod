...
public class CfInfo {
    ...
    public Long getNumBuckets() { return numBuckets; }

    public Long getNumFilters() { return numFilters; }

    public Long getNumItemsInserted() { return numItemsInserted; }

    public Long getNumItemsDeleted() { return numItemsDeleted; }

    public Long getBucketSize() { return bucketSize; }

    public Long getExpansionRate() { return expansionRate; }

    public Long getMaxIteration() { return maxIteration; }
