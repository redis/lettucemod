...
import com.redis.lettucemod.json.protocol.CommandType;
...
public class RedisJSONCommandBuilder<K, V> extends RedisModulesCommandBuilder<K, V> {
    ...
    public Command<K, V, Long> del(K key, K path) {
        ...
        return createCommand(CommandType.DEL, new IntegerOutput<>(codec), args);
    }

    public Command<K, V, V> get(K key, GetOptions<K, V> options, K... paths) {
        CommandArgs<K, V> args = args(key);
        if (options != null) {
            options.build(args);
        }
        args.addKeys(paths);
        return createCommand(CommandType.GET, new ValueOutput<>(codec), args);
    }
    ...
    public Command<K, V, List<V>> mget(K path, K... keys) {
        ...
        args.addKey(path);
        return createCommand(CommandType.MGET, new ValueListOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> mget(KeyValueStreamingChannel<K, V> channel, K path, K... keys) {
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKeys(keys);
        args.addKey(path);
        return createCommand(CommandType.MGET, new KeyValueStreamingOutput<>(codec, channel, Arrays.asList(keys)), args);
    }
    ...
    public Command<K, V, Long> mget(KeyValueStreamingChannel<K, V> channel, K path, Iterable<K> keys) {
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKeys(keys);
        args.addKey(path);
        return createCommand(CommandType.MGET, new KeyValueStreamingOutput<>(codec, channel, keys), args);
    }
    ...
    public Command<K, V, List<KeyValue<K, V>>> mgetKeyValue(K path, K... keys) {
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKeys(keys);
        args.addKey(path);
        return createCommand(CommandType.MGET, new KeyValueListOutput<>(codec, Arrays.asList(keys)), args);
    }
    ...
    public Command<K, V, List<KeyValue<K, V>>> mgetKeyValue(K path, Iterable<K> keys) {
        ...
        CommandArgs<K, V> args = new CommandArgs<>(codec).addKeys(keys);
        args.addKey(path);
        return createCommand(CommandType.MGET, new KeyValueListOutput<>(codec, keys), args);
    }
    ...
    public Command<K, V, String> set(K key, K path, V json, SetMode mode) {
        ...
        args.addValue(json);
        if (mode != null) {
            args.add(mode == SetMode.NX ? CommandKeyword.NX : CommandKeyword.XX);
        }
        return createCommand(CommandType.SET, new StatusOutput<>(codec), args);
    }
    ...
    public Command<K, V, String> type(K key, K path) {
        ...
        return createCommand(CommandType.TYPE, new StatusOutput<>(codec), args);
    }
    ...
    public Command<K, V, V> numIncrBy(K key, K path, double number) {
        ...
        args.addKey(path);
        args.add(number);
        return createCommand(CommandType.NUMINCRBY, new ValueOutput<>(codec), args);
    }
    ...
    public Command<K, V, V> numMultBy(K key, K path, double number) {
        ...
        args.addKey(path);
        args.add(number);
        return createCommand(CommandType.NUMMULTBY, new ValueOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> strAppend(K key, K path, V json) {
        ...
        args.addValue(json);
        return createCommand(CommandType.STRAPPEND, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> strLen(K key, K path) {
        ...
        return createCommand(CommandType.STRLEN, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> arrAppend(K key, K path, V... jsons) {
        ...
        return createCommand(CommandType.ARRAPPEND, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> arrIndex(K key, K path, V jsonScalar, Long start, Long stop) {
        ...
        return createCommand(CommandType.ARRINDEX, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> arrInsert(K key, K path, long index, V... jsons) {
        ...
        notEmpty(jsons, "JSONs");
        args.addValues(jsons);
        return createCommand(CommandType.ARRINSERT, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> arrLen(K key, K path) {
        ...
        return createCommand(CommandType.ARRLEN, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, V> arrPop(K key, K path, Long index) {
        ...
        return createCommand(CommandType.ARRPOP, new ValueOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> arrTrim(K key, K path, long start, long stop) {
        ...
        args.add(start);
        args.add(stop);
        return createCommand(CommandType.ARRTRIM, new IntegerOutput<>(codec), args);
    }
    ...
    public Command<K, V, List<K>> objKeys(K key, K path) {
        ...
        return createCommand(CommandType.OBJKEYS, new KeyListOutput<>(codec), args);
    }
    ...
    public Command<K, V, Long> objLen(K key, K path) {
        ...
        return createCommand(CommandType.OBJLEN, new IntegerOutput<>(codec), args);
    }
